...
-- 2) OPCIONES DE ALOJAMIENTO (una fila por opción de Airbnb/Booking) ----
create table if not exists alojamientos (
  ...
  habitaciones numeric,             -- nº de dormitorios
  banos       numeric,              -- nº de baños
  capacidad   numeric,              -- nº de personas que caben (el grupo son 8)
  parqueo     boolean default true, -- parqueo en sitio (crítico por la van de 9 plazas)
  rating      numeric,              -- valoración del anuncio (ej. 4.8)
  notas       text,
...
-- 5) REALTIME (sync en vivo entre dispositivos de la familia) ----------
--    Añade las tablas a la publicación de realtime de Supabase.
alter publication supabase_realtime add table gastos;
alter publication supabase_realtime add table alojamientos;
